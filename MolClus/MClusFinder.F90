...
do
	...
	call clusSort(molData,numMols,6,sigma,numClus)
...
subroutine clusSort(arrin,dim1,dim2,dParam,maxClus)
...
open(unit=19,file="averages.dat",status="unknown",position="append")
